...
if $cgi.include?("confirmnumber")
 confirm = $cgi["confirmnumber"].to_i
	if userconfirm == QUESTIONS[confirm]
		...
		homepagestr = _("Return to the Doodle homepage and create a new poll")
		wikipediastr = _("Browse a random Wikipedia article")
		searchstr = _("Search for something fun on the Internet")
...
<div class='textcolumn'>
	...
	<ul>
		...
		<li><a href='https://en.wikipedia.org/wiki/Special:Random'>#{wikipediastr}</a></li>
...
$d.html << _("You are about to delete the poll named") + " <b>#{CGI.escapeHTML($d.table.name)}</b>. "
$d.html << "<b><font color='red'>" + _("This is an irreversible action!") + "</b></font><br><br>"
$d.html << _("If you are sure that you want to permanently remove this poll, please type “%{question}” into the form.") % {:question => QUESTIONS[confirm]} + "<br><br>"
deletestr = _("Delete this poll!")
$d.html << %{
	#{hint}
