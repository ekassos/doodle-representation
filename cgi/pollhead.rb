...
EDITDELETE
	...
	def edit_column_htmlform(activecolumn, revision)
		...
		hint = _("Enter all the options (columns) which you want the participants of the poll to choose among. For each option you give here, the participants will choose one of three options: can make it, only if needed, can't make it.")
		ret = <<END
