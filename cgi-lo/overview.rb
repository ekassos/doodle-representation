...
$d << _("Congratulations! Your poll is created. Here's how you can get responses:")

sendlink = _("Share this link with all participants:")
mailstr = _("Send this link via email...")
nextstr = _("Visit the poll yourself using the link below:")
subjectstr = _("Link to Doodle about %{polltitle}") % {:polltitle => $d.title}
$d << <<END
<ol>
	<li>
		#{sendlink}
